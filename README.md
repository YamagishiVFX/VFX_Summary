...
* [VFX（CG）学習資料](https://vook.vc/n/4473) ← New
* VFX制作会社：海外、国内
* VFXを教える学校
    * 海外
    * 国内
...
英語が出来ない僕が言うのもアレだが、映像技術の殆どは海外で生まれ、様々な試行錯誤がされ、その中で特に有効なものはソフトウェア（もしくはプラグイン等）に実装され一般化される。そのような背景があり、映像の技術資料のほとんど（あくまで個人的な体感で9割くらい）は英語の資料になっている。日本語に翻訳されているものはその中の1割あるかどうか？だったり、翻訳されていても間違っていたり、独自解釈であったりすることが多い（僕の記事も独自解釈）。試行錯誤された知見が国内に入ってくることもほとんどない状況となっている。
<br><br>
